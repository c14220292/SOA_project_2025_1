    ...
    <div class="pt-24 bg-[#fffbe9] min-h-screen">
        ...
        <div class="flex justify-center items-center gap-8 py-16 px-4 flex-wrap">
            <div class="bg-[#7a0c0c] border-4 border-[#d4af37] text-center p-8 shadow-xl w-72 rounded-md">
                <h2 class="text-[#d4af37] font-bold text-xl mb-6">PERMINTAAN<br>RESERVASI</h2>
            ...
            <div class="bg-[#7a0c0c] border-4 border-[#d4af37] text-center p-8 shadow-xl w-72 rounded-md">
                <h2 class="text-[#d4af37] font-bold text-xl mb-6">MANAJEMEN<br>MEJA</h2>
            ...
            <div class="bg-[#7a0c0c] border-4 border-[#d4af37] text-center p-8 shadow-xl w-72 rounded-md">
                <h2 class="text-[#d4af37] font-bold text-xl mb-6">MANAJEMEN<br>SLOT WAKTU</h2>
